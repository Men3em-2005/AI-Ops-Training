  ...
  return (
    <div>
      <PageHeader
        ...
        action={
          <Link href="/manager/purchase-orders/new" className={buttonPrimary}>
            New Purchase Order
          </Link>
        }
      />
      <PurchaseOrderTable purchaseOrders={purchaseOrders} basePath="/manager/purchase-orders" showBranch={false} />
    </div>
  );
}
